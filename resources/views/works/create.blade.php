                    ...
                    <div>
                        ...
                        <div class="flex flex-row py-2">
                            <div class="flex-1 w-50 px-4">
                                ...
                                <div class="mt-1">
                                    <select name="project_id" id="project_id" class="relative shadow-sm border py-2 block w-full pl-2 pr-12 sm:text-sm rounded-md">
                            ...
                            <div class="flex-1 w-50 px-4">
                                ...
                                <div class="mt-1">
                                    <select name="worktype_id" id="worktype_id" class="relative shadow-sm border py-2 block w-full pl-2 pr-12 sm:text-sm rounded-md">
