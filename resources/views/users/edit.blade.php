                    ...
                    <div>
                        ...
                        <div class="flex flex-row mt-4">
                            <div class="flex-1 px-2">
                                ...
                                <input type="text" name="name" id="name" class="border py-2 block w-full pl-2 pr-12 sm:text-sm rounded-md" value="{{ $user->name }}">
                                </div>
                            </div>
                            <div class="flex-1 px-4">
                                <label for="email" class="block text-sm font-medium">{{ __('crud.email') }}</label>
                                <div class="mt-1 relative rounded-md shadow-sm">
                                <input type="text" name="email" id="email" class="border py-2  block w-full pl-2 pr-12 sm:text-sm rounded-md" value="{{ $user->email }}">
                                </div>
                            </div>
                        </div>
